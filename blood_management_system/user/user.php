...
<div class="col-sm-3 col-md-3 col-lg-3 col-xl-3" >
          <center>
              <button class="but" style="background-color: #ffffff; border: none;outline: none;" onclick="location.href = ' faculty_details.php'"  ><img src="image/icons8-hospital-64.png"  alt="" width="100px" height="100px"></button>
                                        ...
                                        <br><h3 style="color:black">Hosiptals </h3>
...
<div class="col-sm-3 col-md-3 col-lg-3 col-xl-3" >
          <center>
              <button class="but" style="background-color: #ffffff; border: none;outline: none;" onclick="location.href = ' faculty_details.php'"  ><img src="image/icons8-museum-200.png"  alt="" width="100px" height="100px"></button>
                                        
                                        <br><h3 style="color:black">Blood Banks </h3>
                                        <h4 style="color:black"> </h4>
                                        <h4 style="color:black">Total Blood Banks </h4>
               ...
               $_SESSION['org_username']='seva@gmail.com';
               $username=$_SESSION['org_username'];
                                           $sql = "select count(*) from tbl_blood_bank ";
                                            $result = mysqli_query($conn, $sql);
                                            while ($row = mysqli_fetch_array($result)) {
                                                ?><a href="view_bank.php" style="text-decoration: none"><b><font style="color: #f48d00; font-size: 24px">
                                                    <?php echo $row[0];?></font></b></a>
                                                <?php
                                            }
...
<div class="col-sm-3 col-md-3 col-lg-3 col-xl-3" >
          <center>
              <button class="but" style="background-color: #ffffff; border: none;outline: none;" onclick="location.href = 'view_ocamp.php'"  ><img src="image/icons8-strike-64.png"  alt="" width="100px" height="100px"></button>
               ...
               if (mysqli_connect_errno()) {
                   echo "Failed to connect to MySQL: " . mysqli_connect_error();
                                           ...
                                           $sql = "select count(*) from tbl_camp where camp_venueDate>CURRENT_DATE";
                                            $result = mysqli_query($conn, $sql);
                                            while ($row = mysqli_fetch_array($result)) {
                                                ?><a href="view_ocamp.php" style="text-decoration: none"><b><font style="color: #f48d00; font-size: 24px">
                                                    <?php echo $row[0]; ?></font></b></a>
                                                <?php
                                            }
 ...
 <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3" >
          <center>
                                        ...
                                        <br><h3 style="color:black">Recipients </h3>
                                        <h4 style="color:black">Total Recipients </h4>
               ...
               if (mysqli_connect_errno()) {
                   echo "Failed to connect to MySQL: " . mysqli_connect_error();
                                           ...
                                           $sql = "select count(*) from tbl_recipient ";
                                            $result = mysqli_query($conn, $sql);
                                            while ($row = mysqli_fetch_array($result)) {
                                                ?><a href="view_recipient.php" style="text-decoration: none"><b><font style="color: #f48d00; font-size: 24px">
                                                    <?php echo $row[0]; ?></font></b></a>
                                                <?php
                                            }
