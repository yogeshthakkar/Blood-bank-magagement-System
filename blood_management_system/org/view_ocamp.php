        ...
        <div class="table-wrapper">         
            ...
            <table class="table table-striped table-bordered" id="sc">
               ...
               //echo $_SESSION['org_username'];
                   ...
                   $sql="select * from tbl_camp where camp_org_email='".$username."'";
                   ...
                   if(mysqli_num_rows($result)>0)
                   {
                       ...
                       {
                           echo '</td><td>'.$row["camp_name"].'</td><td>'.$row["camp_org_email"].'</td><td>'.$row["camp_venueDate"].'</td><td>'.$row["camp_registrationDate"].'</td><td>'.$row["camp_location"].'</td><td>'.$row["camp_time"].'</td><td>'.$row["camp_contact"].'</td><td>
