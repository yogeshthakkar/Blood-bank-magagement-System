...
if ($conn->connect_error) {
  ...
  if(mysqli_num_rows($result)>0)
  {
      ...
      {
          echo '<tr><td>'.$row["hospital_name"].'</td><td>'.$row["hospital_email"].'</td><td>'.$row["hospital_address"].'</td><td>'.$row["hospital_contact"].'</td><td>
                    <a href="edit_hospital.php?id='. $row["hospital_email"].'" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                           <a href="hos_delete.php?id='. $row["hospital_email"].'" onclick="return checkDelete()"><i class="material-icons">&#xE872;</i></a>
                        </td></tr>';
