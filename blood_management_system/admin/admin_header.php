...
<title>Blood Bank Management System</title>
 ...
 <link rel="stylesheet" href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/blood_management_system/admin/css/admin.css">
...
<div class="sidebar" id="mySidebar">
 ...
 <div class="setmenu">
  <a href="admin_home.php" style="color:#fff;text-decoration:none;">Home</a>
...
<button class="dropdown-btn">Donor
  ...
  <div class="dropdown-container">
    ...
    <li><a href="view_bloodbank.php">View Bank</a></li>
  </div>
  ...
  <div class="dropdown-container">
    ...
    <li><a href="view_organization.php">View Organization</a></li>
  </div>
  ...
  <div class="dropdown-container">
    ...
    <li><a href="view_camp.php">View Camp</a></li>
  </div>
  ...
  <a href="send_reminder.php" style="color:#fff;text-decoration:none;">Send Reminder</a>
 </div>
</div>
