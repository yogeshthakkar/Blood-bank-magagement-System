...
$_conpass=$_POST["txtnewpass1"];
  ...
  $sql="select * from tbl_blood_bank  where  bloodbank_email='".$eml."' and bloodbank_password='".$_oldpass."' ";

  $res=$conn->query($sql);
  if($res->num_rows==1)
  {
      $sql="update tbl_blood_bank set bloodbank_password='".$_newpass."' where   bloodbank_email='".$eml."' ";
