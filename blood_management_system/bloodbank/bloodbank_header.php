<?php 
session_start();
if(!isset($_SESSION['bloodbank_username'])){
    ?>
<script>
...
<title>Blood Bank Management System</title>
 <link rel="icon" type="image/png" sizes="20x20" href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/blood_management_system/bloodbank/image/bbms.jpg">
<link rel="stylesheet" href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/blood_management_system/bloodbank/css/bloodbank.css">
<link rel="stylesheet" href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/blood_management_system/bloodbank/css/bootstrap.min.css">
...
<div class="sidebar" id="mySidebar">
 ...
 <div class="setmenu">
  <a href="bloodbank.php" style="color: #fff;text-decoration: none;">Home</a>
  <button class="dropdown-btn">BloodBank
    <i class="fa fa-caret-down"></i>
  </button>
  <div class="dropdown-container">
    <li><a href="view_blood.php">View Blood</a></li>
    <li><a href="view_bloodbank.php">View User</a></li>
  </div>
  ...
  <div class="dropdown-container">
    ...
    <li><a href="view_recipient.php">View Recipient</a></li>
  </div>
  ...
  function checkdelete()
  {
    return confirm("Are You Sure To Delete ?");
     ...
     function checkaccept(){
        return confirm("Are you sure  u want to activate?");
    }
