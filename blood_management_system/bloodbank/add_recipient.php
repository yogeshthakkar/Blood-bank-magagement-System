     ...
     <div class="regis">
        ...
        <form method="POST">
         ...
         <div class="col-lg-3 col-sm-4 col-12">
            <div class="birth">
            <span>RELATION</span>
            <input type="text" class="reedatereg" name="txtrec_relation" required>
            </div>
         </div>
       </div>
       ...
       <div class="sdiv">
         <div class="col-lg-6 col-sm-4 col-12">
            ...
            <input type="text" class="reemailreg" placeholder="Patient Name" name="txtrec_patient" required>
          </div>
        </div>
         <div class="col-lg-3 col-sm-4 col-12">
            <div class="district">
        ...
        <div class="tdiv">
         <div class="col-lg-8 col-sm-6 col-12">
              <div class="address">
                <span>ADDRESS</span>
              <textarea class="addressreg" name="txtrec_address" required></textarea>
         </div>
       </div>
       ...
       <div class="fdiv">
         ...
         <input type="text" class="donationreg" name="txtrec_hospital">
         </div>
         </div>
         ...
         <div class="col-lg-6 col-sm-6 col-12">
            ...
            <input type="text" class="reoptionreg" pattern="[a-zA-Z\s]+" name="txtrec_doctor" required>
         </div>
       </div>
