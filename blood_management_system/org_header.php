...
<div class="sidebar" id="mySidebar">
 ...
 <div class="setmenu">
    <a href="./org/org_home.php" style="color:#fff;text-decoration: none;">Home</a>
  <button class="dropdown-btn">Organization
    <i class="fa fa-caret-down"></i>
  </button>
  <div class="dropdown-container">
    <!--<li><a href="Edit_profile.php">Edit Profile</a></li>-->
    <li><a href="./org/view_org.php">View_Details</a></li>
  </div>
<button class="dropdown-btn">camp
  ...
  <div class="dropdown-container">
    ...
    <li><a href="./org/view_ocamp.php">View camp</a></li>
  </div>
