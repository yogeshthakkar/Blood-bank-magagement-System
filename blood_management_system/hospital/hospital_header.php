...
<title>Blood Bank Management System</title>
 <link rel="icon" type="image/png" sizes="20x20" href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/blood_management_system/hospital/image/bbms.jpg">

 <link rel="stylesheet" href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/blood_management_system/hospital/css/hospital.css">
<link rel="stylesheet" href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/blood_management_system//hospital/css/bootstrap.min.css">
...
<header>
   <div class="header">
<i class="fa fa-bars open_icon" onclick="openNav()"  class="openbtn" style="color:#fff;"></i> 
...
<div class="sidebar" id="mySidebar">
 ...
 <div class="setmenu">
  <a href="hospital.php" style="color:#fff;text-decoration: none;">Home</a>
  <button class="dropdown-btn">Hospital
    <i class="fa fa-caret-down"></i>
  </button>
  <div class="dropdown-container">
   <!-- <li><a href="Edit.php">Edit Details</a></li>-->
    <li><a href="view_hospital.php">View Details</a></li>
  </div>
