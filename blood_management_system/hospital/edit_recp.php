 ...
 ?>
       ...
       <div class="fdiv">
         ...
         <div class="col-lg-6 col-sm-6 col-12">
            <div class="remdonodoc">
            <span>DOCTOR NAME</span>
            <input type="text" class="reoptionregdoc" name="r_dname" required value="<?php echo $_rec_dname; ?>">
         </div>
       </div>
       <div class="col-lg-6 col-sm-6 col-12"></div>
             <div class="recreminderid">
              <span>ID</span>
            <input type="text" name="r_id" class="recreminderregid" value="<?php echo $_pk_rec_id; ?>">
          </div>
