     ...
     <div class="regis">
        ...
        <form method="POST">
         ...
         <div class="col-lg-6 col-sm-4 col-12">
            ...
            <input type="text" class="rname" placeholder="Name" pattern="[a-zA-Z\s]+" name="txtrec_name" required>
            </div>
          </div>
         <div class="col-lg-3 col-sm-4 col-12">
            <div class="gender">
            <span>GENDER</span>
            <select class="radioreg" name="txtrec_gender" required>
         ...
         <div class="col-lg-3 col-sm-4 col-12">
            <div class="birth">
            <span>RELATION</span>
            <input type="text" placeholder="Relation with Patient" class="reedatereg" pattern="[a-zA-Z\s]+" name="txtrec_relation" required>
            </div>
         </div>
       </div>
       ...
       <div class="sdiv">
         <div class="col-lg-6 col-sm-4 col-12">
            ...
            <input type="text" class="reemailreg" placeholder="Patient Name" pattern="[a-zA-Z\s]+" name="txtrec_patient" required>
          </div>
        </div>
         <div class="col-lg-3 col-sm-4 col-12">
            <div class="district">
              <span>AREA</span> 
            <select class="districtreg" name="txtrec_area" required>
                <option>-- Select --</option>
         ...
         <div class="col-lg-3 col-sm-4 col-12">
           <div class="mob">
            ...
            <span>MOBILE NO</span>
           <input type="text" class="mobreg" placeholder="MOBILE" name="txtrec_mob" pattern="^\d{10}$" required>
         </div>
       </div>
       </div>
        ...
        <div class="tdiv">
         <div class="col-lg-8 col-sm-6 col-12">
              <div class="address">
                <span>ADDRESS</span>
              <textarea class="addressreg" placeholder="Address" name="txtrec_address" required></textarea>
         </div>
       </div>
         <div class="col-lg-4 col-sm-6 col-12">
              <div class="group"><br>
                <span>BLOOD GROUP</span>
              <select class="groupreg" name="txtrec_bgroup" required>
                <option>-- Select --</option>
       ...
       <div class="fdiv">
         ...
         <input type="text" class="donationreghos" name="txtrec_hospital" placeholder="Enter Hospital Name">
         </div>
         </div>
         ...
         <div class="col-lg-6 col-sm-6 col-12">
            ...
            <input type="text" class="reoptionreg" placeholder="Doctor Name" pattern="[a-zA-Z\s]+" name="txtrec_doctor" required>
         </div>
       </div>
       ...
       <div class="fidiv">
        <div class="col-lg-12 col-sm-12 col-12">
         ...
         <center><input type="submit" name="submit" value="ADD RECIPIENT" class="regtable"></center>
        </div> 
       </div>
       <?php
class recipient {
