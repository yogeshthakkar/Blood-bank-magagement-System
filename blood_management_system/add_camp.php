         ...
         //  $this->camp_registration_date = date('Y-m-d');
           ...
           if (mysqli_query($this->conn, $this->sql)) {
              ...
              while($this->row2=mysqli_fetch_assoc($this->result2)){
                         ...
                         $this->mail->send("help.bloodbanksystem@gmail.com", "New Blood Camp", "Hello '".$this->row2['donor_name']."', <br><br>New blood donation camp has being organized. <br>It's the time again when you can save a life. <br>Details of camps are as follows.<br><br>Camp name: '".$this->camp_organization_name."' <br>Camp venue: '".$this->camp_venue."'<br>Date: '".$this->camp_venue_date."'<br>Time: '".$this->camp_venue_time."'<br>Contact no: '".$this->camp_contact."'<br><br> DONATE BLOOD, SAVE A LIFE!</b> <br><br> Thank you, <br> Blood Bank ",$this->row2['donor_email']);
                            
                          $this->ch = curl_init();
        $this->user = "soniya.daiict@gmail.com:sms123";
        $this->receipientno = $this->camp_contact;
        $this->senderID = "TEST SMS";
        $this->msgtxt = "New Blood Camp!\nDetails:\nCamp name: $this->camp_organization_name \nCamp venue: $this->camp_venue\nDate: $this->camp_venue_date\nTime: $this->camp_venue_time\nContact no: $this->camp_contact\n DONATE BLOOD, SAVE A LIFE!   \nThank you";
        curl_setopt($this->ch, CURLOPT_URL, "http://api.mVaayoo.com/mvaayooapi/MessageCompose");
        curl_setopt($this->ch, CURLOPT_RETURNTRANSFER, 1);
        curl_setopt($this->ch, CURLOPT_POST, 1);
        curl_setopt($this->ch, CURLOPT_POSTFIELDS, "user=$this->user&senderID=$this->senderID&receipientno=$this->receipientno&msgtxt=$this->msgtxt");
